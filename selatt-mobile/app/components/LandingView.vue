    ...
    <RadSideDrawer ref="drawer">
      ...
      <GridLayout ~mainContent columns="*" rows="*">
        <StackLayout>
          ...
          <Label>
            <FormattedString>
              <span class="text-center" text="Algoritmos disponibles:" fontWeight="bold"></span>
              <span :text="newLine"/>
            </FormattedString>
          </Label>
          <Label>
            <FormattedString>
              <span class="text-center" text="Clasificadores: Naive Bayes Naive Bayes Net Hidden "></span>
              <span class="text-center" text="Naive bayes "></span>
            </FormattedString>
          </Label>
          <Label>
            <FormattedString>
              <span class="text-center" text="Ibk Multi Layer Perceptron"></span>
            </FormattedString>
          </Label>
          <Label>
            <FormattedString>
              <span class="text-center" text="Selección de atributos: Variable Neighbourhood Search,"/>
              <span class="text-center" text=" Ranker"></span>
              <span class="text-center" text=", Fast Correlation Based Filter"></span>
              <span class="text-center" text="Scatter Search Exhaustive Search"></span>
            </FormattedString>
          </Label>
