  ...
  <v-app>
    ...
    >
      <v-btn @click="goToHome" text class="d-flex">
        <v-img contain :src="require('./assets/tipografia2.png')" max-height="80" max-width="80"></v-img>
      </v-btn>
    ...
    <v-footer class="text-center">
      <v-col class="text-center"><v-icon>mdi-copyright</v-icon>Copyright 2020 <a href="https://github.com/Kazzpa/tfg-kazzpa">github.com/kazzpa</a>
      </v-col>
    </v-footer>
  </v-app>
</template>
