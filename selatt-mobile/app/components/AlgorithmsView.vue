  ...
  <Page @loaded="on_load">
    ...
    <RadSideDrawer ref="drawer">
      ...
      <StackLayout ~mainContent>
        ...
        <Label>
          <FormattedString>
            <span class="h3" :text="chooseAlgorithmLabel" fontWeight="bold"/>
          </FormattedString>
        </Label>
        <Switch
        ...
        <StackLayout v-if="selectedDataset">
          ...
          <StackLayout orientation="horizontal" v-if="responseData!=null">
            ...
            <NavigationButton @tap="responseData=null" android.systemIcon="ic_menu_close_clear_cancel"
                              text="Cerrar"></NavigationButton>
          </StackLayout>
